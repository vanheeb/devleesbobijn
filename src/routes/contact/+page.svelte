...
<svelte:head>
	...
	<meta name="description" content="Neem contact op met de vleesbobijn. Stuur een bericht, bel ons of bezoek ons in Deerlijk." />
	<meta property="og:title" content="Contact - de vleesbobijn" />
	<meta property="og:description" content="Neem contact op met de vleesbobijn. Stuur een bericht, bel ons of bezoek ons in Deerlijk." />
...
<div class="max-w-6xl mx-auto px-4 py-12">
	<div class="text-center mb-12">
		<h1 class="text-3xl md:text-4xl font-display mb-4">Contact</h1>
		<p class="text-gray-600">Heb je een vraag of wil je een pakket op maat? Neem contact met ons op!</p>
	</div>
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-12">
		...
		<div>
			<h2 class="text-xl font-display mb-6">Onze gegevens</h2>
			<div class="space-y-4">
				<div class="bg-white rounded-xl p-6 border">
					<h3 class="font-display text-base mb-2">📍 Adres</h3>
					<p class="text-gray-600">Achterstraat 20<br />8540 Deerlijk</p>
					<p class="text-sm text-gray-500 mt-2">Hier haal je het materiaal op en breng je het terug.</p>
				</div>
				<div class="bg-white rounded-xl p-6 border">
					<h3 class="font-display text-base mb-2">📞 Telefoon</h3>
					<a href="tel:+32479392283" class="text-primary font-display hover:underline">+32 479 39 22 83</a>
				</div>
				<div class="bg-white rounded-xl p-6 border">
				...
				<div class="bg-white rounded-xl p-6 border">
					...
					<p class="text-gray-600">
						Bereikbaar via telefoon en e-mail.<br />
						Ophaling en terugbreng in overleg.
					</p>
				</div>
			</div>
		</div>
